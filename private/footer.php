  <footer role="contentinfo" aria-label="Footer">
    <div>
      <nav role="navigation" aria-label="Footer Navigation">
        <ul>
          <li><a href="index.php" aria-label="Back to home"><img src="../img/assets/brblogo2.png" alt="Blue Ridge Bounty Logo." height="50" width="150"></a></li>
          ...
          <li><a href="aboutus.php#contact" aria-label="Contact Us">Contact Us</a></li>
          <li><a href="aboutus.php" aria-label="About Us">About Us</a></li>
        </ul>
      </nav>
    </div>
