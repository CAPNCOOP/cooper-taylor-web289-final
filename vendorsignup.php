...
<main>
  ...
  <form action="private/auth.php" method="POST" enctype="multipart/form-data">
    ...
    <div>
      ...
      <fieldset>
        <label for="profile-pic" class="custom-file-label">Profile Picture:</label>
        <input type="file" id="profile-pic" name="profile_image" accept="image/png, image/jpeg, image/webp" required aria-label="Profile Picture" class="file-input">
        <div class="file-preview-container">
          <img id="image-preview" src="" alt="Image Preview" height="250" width="250" class="image-preview">
